...
<div class="container-fluid">    
  <form class="form-horizontal" action="<%=request.getContextPath()%>/community/communityUpdate" method="post" enctype="multipart/form-data">
  	<div class="row">
    ...
    <div class="col-lg-8 content"> 
   		...
   		<div class="row form-group" style="padding-top:40px">
   			...
   			<div class="col-lg-7"id="subContent"style="margin-left:18%">
   				<label for="comment" class="control-label col-sm-2"style="padding-right:17%;">COMMENT</label>
   				<div class="col-sm-9">
